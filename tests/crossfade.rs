...
/// waiting for the pipeline to fill the way it was under engine. What it does cover is the ramp's
...
/// only a landing part way through a frame leaves anything owed, and the targets below are spread
/// so they are not all the same parity.
