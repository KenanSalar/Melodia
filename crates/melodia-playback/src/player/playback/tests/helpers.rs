//! Shared fixtures for this tier's DSP tests.
//!
...
//!
//! The transport fixtures that used to sit beside these left for
//! `player::engine::fixtures`, which three crates read and a `cfg(test)` module
//! cannot serve.
//!
