...
// `bash crates/melodia-app/src/services/updater/tests/fixtures/regen-versioned.sh`.
...
// `bash crates/melodia-app/src/services/updater/tests/fixtures/regen-manifest.sh`.
