...
pub const COMPOSITE_SIZE: u32 = STORE_MAX_DIM;
...
pub fn compose_cover(source_paths: &[PathBuf], side: u32) -> Option<image::RgbImage> {
...
/// one the user chose.
pub fn compose_artwork(source_paths: &[PathBuf], artwork_dir: &Path) -> Option<String> {
