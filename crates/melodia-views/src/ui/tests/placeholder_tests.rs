...
const POPUP_SURFACE: &str =
    include_str!("../../../../melodia-ui/ui/components/popup-surface.slint");
const LABELED_INPUT: &str =
    include_str!("../../../../melodia-ui/ui/components/labeled-input.slint");
