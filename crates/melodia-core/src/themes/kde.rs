...
/// A parsed `kdeglobals` colour scheme.
///
/// Declared here rather than beside the code that reads the file, because both directions of
/// that pairing are needed and only one of them can cross a crate boundary: this is plain data
/// the palette half consumes, and the reader is a platform adapter that produces it. Naming it
/// from there instead made the two mutually dependent.
...
const ACCENTS: &[AccentDef] = &[
    AccentDef { id: "blue", name: "Blue", per_variant: &[("dark", 0x3daee9), ("light", 0x2980b9)] },
    AccentDef { id: "teal", name: "Teal", per_variant: &[("dark", 0x2bc4ac), ("light", 0x038387)] },
    AccentDef {
        id: "green",
        name: "Green",
    ...
    AccentDef { id: "red", name: "Red", per_variant: &[("dark", 0xda4453), ("light", 0xc0392b)] },
    AccentDef {
        id: "purple",
        name: "Purple",
        per_variant: &[("dark", 0x9b59b6), ("light", 0x7d3c98)],
    },
    AccentDef { id: "pink", name: "Pink", per_variant: &[("dark", 0xe966a0), ("light", 0xbf0077)] },
    AccentDef {
        id: "slate",
        name: "Slate",
...
#[cfg(target_os = "linux")]
pub fn palette_from_kde(kde: &KdeColorPalette) -> Palette {
    let g =
