...
const ACCENTS: &[AccentDef] = &[
    ...
    AccentDef {
        id: "green",
        name: "Green",
        per_variant: &[("dark", 0x8de698), ("light", 0x15772e)],
    },
    AccentDef {
        id: "yellow",
        name: "Yellow",
        per_variant: &[("dark", 0xffc057), ("light", 0x905300)],
    },
    AccentDef {
        id: "orange",
        name: "Orange",
    ...
    AccentDef {
        id: "purple",
        name: "Purple",
        per_variant: &[("dark", 0xfba7ff), ("light", 0x8939a4)],
    },
    AccentDef {
        id: "slate",
        name: "Slate",
        per_variant: &[("dark", 0xbbd1e5), ("light", 0x526678)],
    },
];
