...
//!
//! Blocking `std` sockets on a dedicated thread, as `services::integrations::discord::ipc`
...
/// `[u32 LE length][NUL-separated lossy UTF-8 paths]`, `services::integrations::discord::ipc`'s
/// framing.
///
