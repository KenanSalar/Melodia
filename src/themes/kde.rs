...
const ACCENTS: &[AccentDef] = &[
    ...
    AccentDef { id: "green",  name: "Green",  per_variant: &[("dark", 0x27ae60), ("light", 0x1d8348)] },
    AccentDef { id: "orange", name: "Orange", per_variant: &[("dark", 0xf67400), ("light", 0xca5010)] },
    AccentDef { id: "red",    name: "Red",    per_variant: &[("dark", 0xda4453), ("light", 0xc0392b)] },
    AccentDef { id: "purple", name: "Purple", per_variant: &[("dark", 0x9b59b6), ("light", 0x7d3c98)] },
    AccentDef { id: "pink",   name: "Pink",   per_variant: &[("dark", 0xe966a0), ("light", 0xbf0077)] },
    AccentDef { id: "slate",  name: "Slate",  per_variant: &[("dark", 0x7f8c8d), ("light", 0x566573)] },
];
