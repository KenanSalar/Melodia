...
const ACCENTS: &[AccentDef] = &[
    AccentDef {
        id: "blue",
        name: "Blue",
        per_variant: &[("dark", 0x0a84ff), ("light", 0x007aff)],
    },
    AccentDef {
        id: "purple",
        name: "Purple",
        per_variant: &[("dark", 0xbf5af2), ("light", 0x5856d6)],
    },
    AccentDef {
        id: "pink",
        name: "Pink",
        per_variant: &[("dark", 0xff375f), ("light", 0xff2d55)],
    },
    AccentDef {
        id: "red",
        name: "Red",
        per_variant: &[("dark", 0xff453a), ("light", 0xff3b30)],
    },
    AccentDef {
        id: "orange",
        name: "Orange",
        per_variant: &[("dark", 0xff9f0a), ("light", 0xff9500)],
    },
    AccentDef {
        id: "yellow",
        name: "Yellow",
        per_variant: &[("dark", 0xffd60a), ("light", 0xffcc00)],
    },
    AccentDef {
        id: "green",
        name: "Green",
        per_variant: &[("dark", 0x30d158), ("light", 0x28cd41)],
    },
    AccentDef {
        id: "graphite",
        name: "Graphite",
        per_variant: &[("dark", 0x98989d), ("light", 0x8e8e93)],
    },
];
