...
paths:
  ...
  - src/boot/**/*.rs
  - ui/app-window.slint
  - ui/components/custom-titlebar.slint
  - ui/components/macos-titlebar-cluster.slint
  - ui/components/macos-traffic-light.slint
  - ui/views/settings/window-chrome-section.slint
---
